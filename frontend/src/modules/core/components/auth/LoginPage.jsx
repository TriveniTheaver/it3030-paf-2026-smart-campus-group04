...
export default function LoginPage() {
  const { login, overrideToken, logout, loginWithGoogle } = useAuth();
        ...
        <div className="p-12 md:w-7/12">
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className="mt-5 w-full bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 rounded-lg py-3 px-4 flex items-center justify-center gap-3 font-semibold shadow-sm hover:shadow transition-all"
            >
